...
extension Publishers {
    ...
    /// Regex ValidationPublisher factory method
    public static func RegexValidator<Pattern>(
        for publisher: Published<String>.Publisher,
    ...
    public static func OneOfRegexValidator<Pattern>(
        for publisher: Published<String>.Publisher,
    ...
    public static func MultiRegexValidator<Pattern>(
        for publisher: Published<String>.Publisher,
        regexs patterns: [Pattern],
